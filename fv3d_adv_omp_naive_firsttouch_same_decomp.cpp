...
int main() {
    ...
    // First-touch pela mesma decomposição usada no kernel.
    ...
    fv3d::print_report("omp_naive_firsttouch_same_decomp", p, P, decomp.px, decomp.py, decomp.pz, dt, elapsed, err);
    return 0;
}
